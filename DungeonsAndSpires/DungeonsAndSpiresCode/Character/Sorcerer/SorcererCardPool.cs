...
public class SorcererCardPool : CustomCardPoolModel
{
    ...
    {
        //This will attempt to load SorcererCharacter/images/cards/frame.png
    ...
    {
        return ModelDb.CardPool<DASSpellCardPool>().Add(ModelDb.CardPool<DASSimpleWeaponCardPool>()).ToArray();
    }
}